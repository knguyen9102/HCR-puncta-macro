...
vglut3SaveDir=getDirectory("Select folder for saved vglut3 images.");
print("vglut3 folder is: ", vglut3SaveDir);
chrna9SaveDir=getDirectory("Select folder for saved chrna9 images.");
print("chrna9 folder is: ", chrna9SaveDir);
...
saveAs("tiff", vglut3SaveDir + File.separator + CleanName + "_vglut3_maxintensity.tif");
...
saveAs("tiff", chrna9SaveDir + File.separator + CleanName + "_chrna9_maxintensity.tif");
...
waitForUser("Save the Log file to maintain record of image processing and quantification progression.");
run("Close All");
